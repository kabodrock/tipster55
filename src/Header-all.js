        ...
        return (
            <div className="header">
                <header className="main-header">
                    <nav class="navbar navbar-expand-lg fixed-top navbar-light" style={{background: "rgba(70,0,106,0.9"}}>
                        <a className="logo-center" href=""  style={{marginLeft:"120px"}}><img className="logo-img" src={logo2} /></a>
                    ...
                    <div class="modal-dialog ">
                        ...
                        <div class="bg-login">
                            ...
                            <form action="" method="POST" class="df-form">
                                ...
                                <a href="" target="_blank"><p style={{textAlign:"center"}}><span style={{color:"#fb6e00"}}>Register</span>&nbsp;&nbsp;|&nbsp;&nbsp;<span>Forget Password ? </span></p></a>
