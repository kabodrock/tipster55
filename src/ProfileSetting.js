            ...
            <div>
                ...
                <div class="container">
                    <div className="content-all">
                        {/* today top tipster */}
                        <div className="col-lg-10"><h2 className="topic">MY PROFILE SETTING</h2></div>
                        <div class="row">
                                    ...
                                    <div className="more-text" style={{textAlign:"left"}}>
                                        <div class="row">
                                            ...
                                            <div className="col-lg-4 profile-right">
                                                PROFILE PICTURE :
                                                <br/>
                                                <div className="img-user"><FontAwesomeIcon icon={['fas', 'user-circle']} /></div>
                                                <a href=""><button className="more-btn" style={{marginTop:"0px"}}>UPLOAD PHOTO</button></a>
                                                ...
                                                <form action="" method="POST" class="">
                                                    ...
                                                    <div class="">
                                                        <label for="password">NEW PASSWORD : </label>
                                                         <input type="password" id="password2" name="password2" placeholder="Enter your new password here" required="required"/>
                                                    </div>
                                                    <div class="">
                                                        <label for="password">CONFIRM NEW PASSWORD : </label>
                                                         <input type="password" id="password3" name="phone" placeholder="Password again" required="required"/>
                                                    </div>
