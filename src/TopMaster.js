...
export default class TopMaster extends Component {
    render() {
        return (
            <div>
                <Headerall />
                <div class="container">
                    <div className="content-all">
                        {/* today top tipster */}
                        <div className="col-lg-10"><h2 className="topic">TOP PERFORMANCE MASTER TIPSTERS</h2></div>
                    <div class="row">
                    ...
                    <h2 className="topic">MASTER TIPSTERS LEADERBOARD</h2>
                        <table className="tips-table">
                        <thead className="table-header">
                            <tr>
